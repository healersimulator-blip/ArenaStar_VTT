...
- **Remaining P08:** Ride DC 20/5/15 in the movement gate, shared initiative/space (Large mount 2×2), falls/unconscious 50/75%, mounted feats (Ride-By ordering, ×3 spirited charge). P09 now queues grit, burst geometry/Reflex, clears, load-provoke, strategic columns and readout polish (D-215 left the gate + broken write wired).
