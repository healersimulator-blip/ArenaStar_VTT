...
export const PRECREATED_PF1E_UNITS: Record<string, RawPF1eProfile> = {
  ...
  // ── M16: the rest of the mirror set ──────────────────────────────────────────────
  //
  // One row per unit role the `pf1e-core` bestiary pack ships, in the same authored numbers.
  // Two tests hold the two halves together: `tests/packages/pf1ePackage.test.ts` compiles every
  // pack entry and compares it against the row it matches by name, and
  // `tests/packages/pf1eContentPacks.test.ts` recomputes the derived AC, touch AC, saves
  // and BAB from the shared tables (`rulesTables.ts`) rather than trusting the typing. So these
  // rows are not a second source of truth — they are the same content, checked twice.
  //
  // The six rows above stay exactly as authored (they are what the demo deploys and what the
  // measured fixtures moved around in D-227); these are additive.
  "light-infantry": {
    name: "Light Infantry",
    bab: 0,
    strMod: 1,
    ...
    armorBonus: 0,
    shieldBonus: 1,
    weapon: { damageDiceCount: 1, damageDiceSides: 8, damageMod: 1 },
  },
  "pikemen": {
    name: "Pike Block",
    bab: 0,
  ...
  "slingers": {
    ...
    armorBonus: 0,
    shieldBonus: 0,
    weapon: { damageDiceCount: 1, damageDiceSides: 6, damageMod: 1, isRanged: true, rangeIncrement: 50 },
  },
  "longbowmen": {
    name: "Longbow Flight",
    bab: 0,
    ...
    armorBonus: 0,
    shieldBonus: 0,
    weapon: { damageDiceCount: 1, damageDiceSides: 8, damageMod: 1, isRanged: true, rangeIncrement: 100 },
  },
  "crossbowmen": {
    name: "Heavy Crossbow Rank",
    bab: 0,
    strMod: 1,
    dexMod: 2,
    sizeMod: 0,
    ...
    armorBonus: 0,
    shieldBonus: 0,
    weapon: { damageDiceCount: 1, damageDiceSides: 10, damageMod: 1, isRanged: true, rangeIncrement: 120 },
  },
  "halberdiers": {
    name: "Halberd Guard",
    bab: 1,
    ...
    armorBonus: 2,
    shieldBonus: 0,
    weapon: { damageDiceCount: 1, damageDiceSides: 10, damageMod: 4 },
  },
  "spear-levy": {
    name: "Spear Levy",
    bab: 0,
    ...
    armorBonus: 0,
    shieldBonus: 1,
    weapon: { damageDiceCount: 1, damageDiceSides: 8, damageMod: 0 },
  },
  "javelineers": {
    name: "Javelin Skirmishers",
    bab: 1,
    strMod: 2,
    dexMod: 3,
    sizeMod: 0,
    ...
    armorBonus: 0,
    shieldBonus: 0,
    weapon: { damageDiceCount: 1, damageDiceSides: 6, damageMod: 2, isRanged: true, rangeIncrement: 30 },
  },
  "guard-dogs": {
    name: "War Canine Pack",
    bab: 1,
    strMod: 3,
    dexMod: 3,
    sizeMod: 0,
    ...
    armorBonus: 0,
    shieldBonus: 0,
    weapon: { damageDiceCount: 1, damageDiceSides: 6, damageMod: 4 },
  },
  "riding-horse": {
    name: "Light Horse",
    bab: 1,
    ...
    armorBonus: 0,
    shieldBonus: 0,
    weapon: { damageDiceCount: 1, damageDiceSides: 6, damageMod: 6 },
  },
  "warhorse": {
    name: "Heavy Horse",
    bab: 3,
    ...
    armorBonus: 0,
    shieldBonus: 0,
    weapon: { damageDiceCount: 1, damageDiceSides: 8, damageMod: 8 },
  },
  "camel": {
    name: "Pack Camel",
    bab: 3,
  ...
  "elephant": {
    ...
    hasTrample: true,
    trampleDamageDiceCount: 2,
    trampleDamageDiceSides: 8,
    weapon: { damageDiceCount: 2, damageDiceSides: 6, damageMod: 10 },
  },
  "dire-wolf": {
    name: "Dire Wolf Pack",
    bab: 3,
  ...
  "boar-herd": {
    ...
    armorBonus: 0,
    shieldBonus: 0,
    weapon: { damageDiceCount: 1, damageDiceSides: 8, damageMod: 5 },
  },
  "brown-bear": {
    name: "Brown Bear Shock",
    bab: 4,
    strMod: 8,
    dexMod: 3,
    sizeMod: -1,
    ...
    armorBonus: 0,
    shieldBonus: 0,
    weapon: { damageDiceCount: 1, damageDiceSides: 8, damageMod: 10 },
  },
  "lion-pride": {
    name: "Lion Pride",
    bab: 3,
    ...
    armorBonus: 0,
    shieldBonus: 0,
    weapon: { damageDiceCount: 1, damageDiceSides: 8, damageMod: 7 },
  },
  "eagles": {
    name: "War Eagle Flight",
    bab: 3,
    strMod: 6,
    dexMod: 3,
    sizeMod: -1,
  ...
  "ogre-clubbers": {
    ...
    armorBonus: 0,
    shieldBonus: 0,
    weapon: { damageDiceCount: 1, damageDiceSides: 10, damageMod: 9 },
  },
  "ettin": {
    name: "Ettin Warline",
    bab: 8,
    ...
    armorBonus: 0,
    shieldBonus: 0,
    weapon: { damageDiceCount: 1, damageDiceSides: 10, damageMod: 11 },
  },
  "hill-giant": {
    name: "Hill Giant Hurlers",
    bab: 8,
    strMod: 8,
    sizeMod: -2,
    specialSizeMod: 2,
    ...
    armorBonus: 0,
    shieldBonus: 0,
    weapon: { damageDiceCount: 1, damageDiceSides: 10, damageMod: 12 },
  },
  "stone-giant": {
    name: "Stone Giant Slingers",
    bab: 9,
    strMod: 8,
    dexMod: 4,
    sizeMod: -2,
  ...
  "fire-giant": {
    ...
    armorBonus: 4,
    shieldBonus: 0,
    dr: { typeFlags: PF1eDrType.BLUDGEONING | PF1eDrType.PIERCING | PF1eDrType.SLASHING, val: 10 },
    weapon: { damageDiceCount: 1, damageDiceSides: 10, damageMod: 13 },
  },
  "minotaur": {
    name: "Minotaur Axe Berserkers",
    bab: 6,
    strMod: 6,
    dexMod: 3,
    sizeMod: -1,
  ...
  "centaur": {
    ...
    armorBonus: 0,
    shieldBonus: 0,
    weapon: { damageDiceCount: 1, damageDiceSides: 8, damageMod: 4, isRanged: true, rangeIncrement: 110 },
  },
  "harpy": {
    name: "Harpy Sky Line",
    bab: 3,
    ...
    armorBonus: 0,
    shieldBonus: 0,
    weapon: { damageDiceCount: 1, damageDiceSides: 6, damageMod: 3 },
  },
  "basilisk": {
    name: "Basilisk Stone Line",
    bab: 4,
    strMod: 3,
    sizeMod: 0,
    ac: 15,
  ...
  "golem-iron": {
    ...
    sr: 27,
    dr: { typeFlags: PF1eDrType.ADAMANTINE, val: 10 },
    weapon: { damageDiceCount: 2, damageDiceSides: 10, damageMod: 9 },
  },
  "sapper-team": {
    name: "Siege Sappers",
    bab: 0,
  ...
  "hero-wizard": {
    ...
    castingStatMod: 4,
    spellPenetration: 5,
    weapon: { damageDiceCount: 1, damageDiceSides: 4, damageMod: 0, isRanged: true, rangeIncrement: 0 },
  },
  "hero-barbarian": {
    name: "Berserker Hero",
    bab: 11,
    ...
    armorBonus: 0,
    shieldBonus: 0,
    weapon: { damageDiceCount: 1, damageDiceSides: 12, damageMod: 10, critThreatMin: 19, critMultiplier: 2 },
  },
  "hero-rogue": {
    name: "Infiltrator Hero",
    bab: 8,
    strMod: 3,
    dexMod: 7,
    sizeMod: 0,
    ...
    armorBonus: 3,
    shieldBonus: 1,
    weapon: { damageDiceCount: 1, damageDiceSides: 8, damageMod: 6, critThreatMin: 19, critMultiplier: 2 },
  },
  "hero-cleric": {
    name: "Warpriest Hero",
    bab: 11,
    ...
    armorBonus: 5,
    shieldBonus: 1,
    dr: { typeFlags: PF1eDrType.MAGIC, val: 3 },
    weapon: { damageDiceCount: 1, damageDiceSides: 8, damageMod: 8 },
  },
  "hero-ranger": {
    name: "Huntmaster Hero",
    bab: 11,
    strMod: 5,
    dexMod: 5,
    sizeMod: 0,
    ...
    armorBonus: 4,
    shieldBonus: 0,
    weapon: { damageDiceCount: 1, damageDiceSides: 10, damageMod: 7, critThreatMin: 19, critMultiplier: 2 },
  },
};
